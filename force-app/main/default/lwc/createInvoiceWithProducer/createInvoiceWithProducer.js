...
import getProducerDetails from "@salesforce/apex/createInvoiceCtrl.getProducerDetails";
...
export default class CreateInvoiceWithProducer extends NavigationMixin(LightningElement) {
  ...
  // call first time 
  connectedCallback() {
        //console.log('CreateInvoiceWithProducer');
      ...
      getBillingAddress({
          ...
          .then(result => {
              ...
              this._duedateval=result.Desired_Attachment_Date__c;
                ////console.log('Desired Attachment Date 2::'+result.Desired_Attachment_Date__c);
          ...
          getProducerDetails({
            ...
            .then(result => {
                ...
                //  ////console.log('resut '+JSON.stringify(result))
                  ////console.log('02 this.companyId'+ this.companyId);
                this._QB_Company_Name__c = result.Applicant_Insured__r.Name;
                this._QB_Street_Address__c = result.Applicant_Insured__r.Physical_Street_Address__c;
                this._QB_City__c = result.Applicant_Insured__r.Physical_City__c ;
                this._QB_Region__c = result.Applicant_Insured__r.Physical_State__c;
                this._QB_Postal_Code__c = result.Applicant_Insured__r.Physical_Zip_Code__c;
                this._QB_Country__c = result.Applicant_Insured__r.Physical_Address_2__c   ;
                this._QB_Given_First_Name__c = result.Producer__r.Name;
                this._QB_Family_Last_Name__c = result.Producer__r.Agency_Name__c;
                  ////console.log( ' this._QB_Family_Last_Name__c:::'+this._QB_Family_Last_Name__c);
                this._QB_Email__c = result.Producer__r.Email		;
                this._QB_Phone_Number__c = result.Producer__r.MobilePhone;
            })
            .catch(error => {
                  ////console.log('error');
            })   
 ...
 async handleAlertClick() {
  ...
  createInvoiceHandler() {
      ...
      if (inceptionDate != null && inceptionDate != '') {
        //   invoiceObj.Inception_Date__c = inceptionDate;
      ...
      //console.log('Error Inc '+anyError);
      ...
      //console.log('Error Policy '+anyError);
      ...
      if (blankRow.length > 0) {
        ...
        console.log('invoice data '+JSON.stringify(lineItemDataList));
         //anyError = true;
