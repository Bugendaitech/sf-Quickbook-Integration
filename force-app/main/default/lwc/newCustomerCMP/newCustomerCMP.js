...
export default class NewCustomerCMP extends LightningElement {
    ...
    //          //console.log('ths '+this.applicantId);
    ...
    //             this.showToastNotification('error',"Please Select any Existing Customer Otherewise Create New Customer.");
    //         }else{
    //             this.currentStep = event.target.value;
    //         }
    //     }else{
    ...
    //Navigate to Create Invoice from New customer Id
    handlecustNavId(event){	        
        //console.log('called HandleCustNavId '+JSON.stringify(event));
        let recValue = event.detail;  
        this.navCustomerId=recValue;
        if(recValue!=''){
