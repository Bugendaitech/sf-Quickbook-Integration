...
// import  getDataByFilter from '@salesforce/apex/InvoiceListCtrl.getDataByFilter';
import { refreshApex } from '@salesforce/apex';
import getInvoicesList from '@salesforce/apex/InvoiceListCtrl.getInvoicesList';


export default class InvoiceListCMP extends NavigationMixin(LightningElement)  {
    @track records = [];
    serachKey       = "";
